...
void log_info(char *msg) {
    __socket_log_write(socket_LOG_INFO, TAG, msg);

    free(msg);
}

void log_error(char *msg) {
    __socket_log_write(socket_LOG_ERROR, TAG, msg);

    free(msg);
}

void log_warn(char *msg) {
    __socket_log_write(socket_LOG_WARN, TAG, msg);

    free(msg);
}

void log_debug(char *msg) {
    __socket_log_write(socket_LOG_DEBUG, TAG, msg);

    free(msg);
}

void log_verbose(char *msg) {
    __socket_log_write(socket_LOG_VERBOSE, TAG, msg);
